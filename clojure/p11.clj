(ns p11
  (:use [utils :only (m-get product timed-test)]))

(def m [[ 8  2 22 97 38 15  0 40  0 75  4  5  7 78 52 12 50 77 91  8]
...
(defn groups [pos]
  (let [right (fn [[row col]] (for [i (range 4)] [row (+ col i)]))
    ...
    (vector (right pos) (down pos) (dr pos) (dl pos))))
...
(timed-test
 "Problem 11"
 70600674
 (apply max (map group-product all-groups)))
